...
const _dartPackage = [
  'name: action_app',
  'version: 1.0.0',
  'description: Github action app that helps to run flutterando_metrics in CI/CD flow.',
  'homepage: https://github.com/dart-code-checker/flutterando-metrics-action',
  'issue_tracker: https://github.com/dart-code-checker/flutterando-metrics-action/issues',
  'publish_to: none',
  '',
  'environment:',
  '  sdk: ">=2.12.0 <3.0.0"',
  '',
  'dependencies:',
  '  flutterando_metrics: ^4.0.0-dev.5',
  '  github: ^8.1.0',
  '  meta: ^1.4.0',
  '  path: ^1.8.0',
  '',
